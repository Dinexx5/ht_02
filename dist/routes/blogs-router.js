...
exports.blogsRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const blogs = yield blogs_repository_inmemory_1.blogsRepository.getAllBlogs();
    res.status(200).send(blogs);
}));
exports.blogsRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let blog = yield blogs_repository_inmemory_1.blogsRepository.getBlogById(req.params.id);
    if (!blog) {
        res.send(404);
    }
    else {
...
exports.blogsRouter.post('/', input_validation_1.basicAuthorisation, nameValidation, descriptionValidation, websiteUrlValidation, input_validation_1.inputValidationMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newBlog = yield blogs_repository_inmemory_1.blogsRepository.createBlogs(name, description, websiteUrl);
    res.status(201).send(newBlog);
}));
exports.blogsRouter.delete('/:id', input_validation_1.basicAuthorisation, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const isDeleted = yield blogs_repository_inmemory_1.blogsRepository.deleteBlogById(req.params.id);
    if (isDeleted) {
        res.send(204);
    }
    else {
...
exports.blogsRouter.put('/:id', input_validation_1.basicAuthorisation, nameValidation, descriptionValidation, websiteUrlValidation, input_validation_1.inputValidationMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name, description, websiteUrl } = req.body;
    let isUpdated = yield blogs_repository_inmemory_1.blogsRepository.UpdateBlogById(id, name, description, websiteUrl);
    if (isUpdated) {
        res.send(204);
    }
    else {
